<div class="container">
        <div class="row">
            <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 milieu">
                <form class="form_login" id="form" name="form" action="" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
            <div class="col">
            <div class="row overflow-hidden position-relative btn1">
                            <input type="file" class="btn btn-info" accept="image/*" name="photo" id="photo" onchange="loadFile(event)" value="Choisir un avatar">
                            <button class="btn btn-info border-0 rounded mb-2">Choisir un avatar</button>
                    </div>
                    <div class="row">
                        <div class="col text-center">
                        <button type="submit" name="compte" id="compte" class="btn btn-info ">Créer un compte</button>
                        </div>
                    </div>
            </div>
        </div>
...
<script src="public/js/inscriptionAdmin.js"></script>
