    ...
    <div class="col shadow-sm bg-light rounded overflow-auto" style="height: 400px;">
      <form action="" method="post" id="form">
        <div class="form-group">
          ...
          <textarea class="form-control" id="libelle" name="libelle" rows="3"></textarea>
          <span class="form_error"></span><br />
        </div>
        <div class="form-group form-inline">
          <label class="my-1 mr-2" for="number">Nombre de points</label>
          <input type="number" class="form-control mr-2" id="nbr_points" name="nbr_points" placeholder="Nombre de points">
          <span class="form_error"></span><br />
        </div>
        <div class="form-group form-inline">
          <label class="my-1 mr-2" for="number">Type de réponses</label>
          <select class="custom-select" id="type" name="type" onChange="choixRep()">
